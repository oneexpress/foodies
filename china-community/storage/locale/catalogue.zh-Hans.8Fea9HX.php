...
',
    ...
    'flarum-mentions.forum.mentioned_by.title' => '所有回复',
    ...
    'flarum-mentions.forum.post.mentioned_by_more_text' => '等 {count} 个回帖。',
    ...
    'flarum-sticky.forum.post_stream.discussion_stickied_text' => '{username} 于 {time} 置顶此帖',
    'flarum-sticky.forum.post_stream.discussion_unstickied_text' => '{username} 于 {time} 取消置顶',
...
',
    ...
    'flarum-lock.forum.post_stream.discussion_locked_text' => '{username} 于 {time} 锁定此帖',
    'flarum-lock.forum.post_stream.discussion_unlocked_text' => '{username} 于 {time} 解锁此帖',
    ...
    'flarum-likes.forum.post.liked_by_text' => '{users} 觉得很赞',
    ...
    'flarum-tags.forum.post_stream.added_and_removed_tags_text' => '{username} 于 {time} 添加 {tagsAdded}，并移除 {tagsRemoved}。',
    'flarum-tags.forum.post_stream.added_tags_text' => '{username} 于 {time} 添加 {tagsAdded}',
    'flarum-tags.forum.post_stream.removed_tags_text' => '{username} 于 {time} 移除 {tagsRemoved}',
    'flarum-tags.forum.post_stream.tags_text' => '{tags} 标签',
    'flarum-tags.forum.tag.meta_description_text' => '{tag} 标签下的所有主题',
    'flarum-tags.lib.deleted_tag_text' => '已删除',
    'flarum-tags.lib.tag_selection_modal.bypass_requirements' => '忽略标签选择',
    'flarum-tags.lib.tag_selection_modal.choose_primary_placeholder' => '{count, plural, one {请选择一个主标签} other {请选择 # 个主标签}}',
    ...
    'flarum-tags.ref.choose_tags_placeholder' => '{count, plural, one {请再选择一个标签} other {请再选择 # 个标签}}',
...
',
    ...
    'core.admin.appearance.custom_styles_cannot_use_less_features' => '自定义 LESS 不支持使用 @import 与 data-uri 特性。',
    ...
    'core.admin.appearance.logo_heading' => '标志',
    ...
    'core.admin.create_user.email_confirmed_label' => '需要用户验证邮箱',
    'core.admin.create_user.email_placeholder' => '=> core.ref.email',
    'core.admin.create_user.password_placeholder' => '=> core.ref.password',
    'core.admin.create_user.submit_and_create_another_button' => '添加下一个',
    'core.admin.create_user.submit_button' => '添加用户',
    'core.admin.create_user.title' => '添加新用户',
    'core.admin.create_user.use_random_password' => '生成随机密码',
    ...
    'core.admin.dashboard.status.headers.queue-driver' => '队列驱动程序',
    'core.admin.dashboard.status.headers.scheduler-status' => '任务调度程序',
    'core.admin.dashboard.status.headers.session-driver' => '会话驱动程序',
    'core.admin.dashboard.status.scheduler.active' => '激活',
    'core.admin.dashboard.status.scheduler.inactive' => '未激活',
    'core.admin.dashboard.status.scheduler.never-run' => '从未运行',
...
',
    ...
    'core.admin.permissions.allow_hide_own_posts_label' => '允许删除自己的帖子',
    'core.admin.permissions.allow_post_editing_label' => '编辑帖子内容',
    'core.admin.permissions.allow_renaming_label' => '更改自己的主题标题',
    'core.admin.permissions.create_access_token_label' => '创建访问令牌',
    ...
    'core.admin.permissions.edit_users_credentials_label' => '编辑用户核心数据（用户名、邮箱和密码）',
    'core.admin.permissions.edit_users_groups_label' => '编辑用户组',
    'core.admin.permissions.edit_users_label' => '编辑用户（昵称等其他数据）',
    'core.admin.permissions.global_heading' => '全局',
    'core.admin.permissions.moderate_access_tokens_label' => '管理访问令牌',
    ...
    'core.admin.users.create_user_button' => '添加用户',
    'core.admin.users.description' => '论坛用户分页列表',
    'core.admin.users.grid.columns.display_name.title' => '外显昵称',
    ...
    'core.admin.users.grid.columns.user_actions.title' => '操作',
    ...
    'core.admin.users.pagination.first_button' => '返回首页',
    'core.admin.users.pagination.go_to_page_textbox_a11y_label' => '翻页到页码',
    'core.admin.users.pagination.last_button' => '前往最后一页',
    ...
    'core.api.invalid_filter_type.must_be_numeric_message' => '{filter} 查询条件必须是数值。',
    'core.api.invalid_filter_type.must_not_be_array_message' => '{filter} 查询条件不能是数组。',
    'core.api.invalid_filter_type.must_not_be_multidimensional_array_message' => '{filter} 查询条件不能是多维数组。',
...
',
    ...
    'core.forum.post_stream.discussion_renamed_text' => '{username} 于 {time} 更改标题为「{new}」',
    ...
    'core.forum.security.browser_on_operating_system' => '{browser}（{os} 平台）',
    'core.forum.security.cannot_terminate_current_session' => '无法终止当前活动会话，请登出。',
    'core.forum.security.created' => '创建时间',
    'core.forum.security.current_active_session' => '当前活动会话',
    'core.forum.security.developer_tokens_heading' => '开发者令牌',
    'core.forum.security.empty_text' => '无可用令牌。',
    'core.forum.security.global_logout.heading' => '全局登出',
    'core.forum.security.global_logout.help_text' => '清除当前 Cookie 会话、终止所有会话、撤销所有开发者令牌，并使一切验证邮箱或重置密码的链接失效。',
    'core.forum.security.global_logout.log_out_button' => '=> core.ref.log_out',
    'core.forum.security.hide_access_token' => '隐藏令牌',
    'core.forum.security.last_activity' => '最近活动',
    'core.forum.security.never' => '=> core.ref.never',
    'core.forum.security.new_access_token_button' => '=> core.ref.new_token',
    'core.forum.security.new_access_token_modal.submit_button' => '创建令牌',
    'core.forum.security.new_access_token_modal.title' => '=> core.ref.new_token',
    'core.forum.security.new_access_token_modal.title_placeholder' => '名称',
    'core.forum.security.revoke_access_token' => '撤销',
    'core.forum.security.revoke_access_token_confirmation' => '=> core.ref.generic_confirmation_message',
    'core.forum.security.session_terminated' => '{count, plural, one {会话已终止} other {已终止 # 个会话}}。',
    'core.forum.security.session_termination_failed' => '终止会话时出现错误。',
    'core.forum.security.sessions_heading' => '活动会话',
    'core.forum.security.show_access_token' => '查看令牌',
    'core.forum.security.terminate_all_other_sessions' => '终止其他所有会话',
    'core.forum.security.terminate_all_other_sessions_confirmation' => '=> core.ref.generic_confirmation_message',
    'core.forum.security.terminate_session' => '终止',
    'core.forum.security.title' => '=> core.ref.security',
    'core.forum.security.token_item_title' => '{title} - {token}',
    'core.forum.security.token_revoked' => '令牌已撤销。',
    ...
    'core.lib.datetime_formats.humanTimeShort' => 'MMMD日',
    'core.lib.datetime_formats.scrubber' => 'YYYY年MMM',
    ...
    'core.lib.error.circular_dependencies_message' => '检测到循环依赖关系：{extensions}。正在中止操作。请禁用其中一个扩展，然后重试。',
    ...
    'core.lib.error.generic_cross_origin_message' => '跨域请求时出现问题，请刷新页面后重试。',
    ...
    'core.lib.error.payload_too_large_message' => '上传内容过大。',
    ...
    'core.lib.series.three_text' => '{first}、{second} 与 {third}',
    ...
    'core.ref.generic_confirmation_message' => '此操作无法撤销，确定要继续吗？',
    'core.ref.icon' => '图标',
    ...
    'core.ref.log_in' => '登录',
    'core.ref.log_out' => '退出',
    'core.ref.mark_all_as_read' => '全部已读',
    'core.ref.never' => '无',
    'core.ref.new_token' => '创建令牌',
    ...
    'core.ref.search_users' => '搜索用户',
    'core.ref.security' => '安全',
