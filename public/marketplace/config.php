<?php
// HTTP
define('HTTP_SERVER', 'https://expressvisa.one/marketplace/');

// HTTPS
define('HTTPS_SERVER', 'https://expressvisa.one/marketplace/');

// DIR
define('DIR_APPLICATION', '/var/www/html/visa/public/marketplace/catalog/');
