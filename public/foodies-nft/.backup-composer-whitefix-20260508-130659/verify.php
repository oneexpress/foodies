...
<main class="wrap">
  ...
  <section class="main">
    <div class="card">
        ...
        <div class="composer-viewer">
          <div class="composer-toolbar">
            ...
            <div class="composer-right">
              ...
              <button class="composer-btn" type="button" onclick="zoomPdf(5);playSfx('click')">+</button>
              <button class="composer-btn" type="button" onclick="document.getElementById('composerPdfFrame').contentWindow.print();playSfx('click')">⎙</button>
      ...
      <div class="btnrow">
        <a class="btn" href="<?= h($pdfUrl) ?>" target="_blank" onclick="playSfx('click')">Open PDF</a>
