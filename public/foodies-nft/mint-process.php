...
*{box-sizing:border-box}body{margin:0;background:radial-gradient(circle at top,#fff 0,#fff3f4 28%,var(--bg) 62%);font-family:Arial,Helvetica,sans-serif;color:var(--ink);padding-bottom:128px}.wrap{max-width:1240px;margin:0 auto;padding:18px}.top{display:flex;justify-content:space-between;align-items:center;gap:12px;margin-bottom:14px}.back{background:#111;color:#fff;text-decoration:none;border-radius:999px;padding:11px 15px;font-weight:1000}.lang{display:flex;gap:8px}.lang button{border:1px solid var(--line);background:#fff;border-radius:999px;padding:9px 13px;font-weight:1000;cursor:pointer}.lang .active{background:var(--red);color:#fff}.hero{background:linear-gradient(135deg,var(--red),var(--dark));border-radius:30px;color:#fff;padding:24px;box-shadow:0 20px 52px rgba(230,0,18,.25)}.hero h1{margin:0 0 8px;font-size:30px}.hero p{margin:0;line-height:1.55;opacity:.92}.wallet{margin-top:14px;display:flex;align-items:center;gap:10px;background:rgba(255,255,255,.15);border:1px solid rgba(255,255,255,.24);border-radius:18px;padding:12px 14px;font-weight:1000}.led{width:12px;height:12px;border-radius:50%;background:#ef4444;box-shadow:0 0 0 5px rgba(239,68,68,.13),0 0 16px rgba(239,68,68,.75)}.led.on{background:var(--green);box-shadow:0 0 0 5px rgba(34,197,94,.16),0 0 18px rgba(34,197,94,.95)}.grid{display:grid;grid-template-columns:430px 1fr;gap:16px;margin-top:16px}.card{background:#fff;border:1px solid var(--line);border-radius:24px;padding:18px;box-shadow:0 12px 30px rgba(0,0,0,.07)}.preview{background:#111;border-radius:22px;overflow:hidden;display:flex;align-items:center;justify-content:center;min-height:520px}.preview img{max-width:100%;height:auto;display:block}.meta{font-size:13px;color:#475467;line-height:1.75;word-break:break-word}.meta b{color:#111}.steps{display:grid;gap:11px}.step{display:grid;grid-template-columns:34px 1fr auto;gap:10px;align-items:center;border:1px solid var(--line);border-radius:18px;padding:13px;background:#fff}.num{width:34px;height:34px;border-radius:13px;background:#fff1f2;color:var(--red);font-weight:1000;display:flex;align-items:center;justify-content:center}.step.ready .num{background:#dcfce7;color:#15803d}.step.wait .num{background:#fef3c7;color:#92400e}.step h3{margin:0;font-size:15px}.step p{margin:3px 0 0;color:var(--muted);font-size:12px}.status{font-size:11px;font-weight:1000;border-radius:999px;padding:7px 9px;background:#fee2e2;color:#b91c1c}.step.ready .status{background:#dcfce7;color:#15803d}.step.wait .status{background:#fef3c7;color:#92400e}.actions{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-top:14px}.btn{border:0;border-radius:16px;background:var(--red);color:#fff;font-weight:1000;padding:14px 12px;text-decoration:none;text-align:center;cursor:pointer}.btn.dark{background:#111}.btn.green{background:var(--green)}pre{white-space:pre-wrap;background:#101828;color:#e5e7eb;border-radius:18px;padding:14px;font-size:11px;max-height:310px;overflow:auto}@media(max-width:900px){.grid{grid-template-columns:1fr}.preview{min-height:auto}.actions{grid-template-columns:1fr}.hero h1{font-size:24px}}
</style>
</head>
<body>
<div class="wrap">
