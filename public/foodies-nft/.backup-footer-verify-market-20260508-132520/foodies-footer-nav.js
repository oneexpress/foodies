  ...
  function render(){
    ...
    nav.innerHTML =
      '<div class="foodies-footer-row">' +
        ...
        '<a class="foodies-footer-btn '+(m==="issue"?'is-active':'')+'" href="/foodies-nft/verify.php?uid=FOODIES-RWA-PENDING"><span class="foodies-footer-icon">✓</span><span>Verify</span></a>' +
