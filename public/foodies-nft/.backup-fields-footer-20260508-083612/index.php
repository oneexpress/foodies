    ...
    <div class="card">
      ...
      <form id="issueForm" class="form">
        ...
        <div id="newFields">
          ...
          <label>Food / Hygiene Notes
            <textarea name="notes" placeholder="Short cert notes"></textarea>
          </label>
        </div>
...
<script src="/foodies-nft/assets/foodies-footer-nav.js?v=compact-row-v1" defer></script>
</body>
</html>
