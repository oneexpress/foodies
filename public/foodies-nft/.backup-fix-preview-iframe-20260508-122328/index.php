...
<main class="wrap">
  ...
  <section class="grid">
    ...
    <aside class="card pdf-preview-card">
      <h2>Foodies RWA Preview</h2>
      <div class="preview-tabs">
        <button type="button" class="preview-tab-btn active" id="pdfPreviewTabBtn" onclick="setFoodiesPreviewTab('pdf')">RWA Cert PDF Preview</button>
      ...
      <div class="preview-panel" id="pdfPreviewPanel">
        <div class="pdf-preview-frame">
          <iframe id="pdfDesignFrame" class="pdf-design-live-frame" src="/foodies-nft/pdf-design.php?star=1"></iframe>
        </div>
      </div>
      ...
      <div class="pdf-actions">
        <a id="openPdfDesignBtn" href="/foodies-nft/pdf-design.php?star=1" target="_blank">Open PDF Design</a>
