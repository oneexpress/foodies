...
export async function run(provider: NetworkProvider) {
  ...
  const master = Address.parse('EQBuZ2-qxsK7cMr6wmhRHhPtdt1qYiZ09JrL1RR5AQ5Gscee');
  const amount = 100_000_000n * 1_000_000_000n;
  ...
  console.log('vSHARE genesis mint sent:', amount.toString());
}
